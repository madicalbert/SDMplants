---
title: "Species occurrence data and background points - ANNOTATED"
author: "Nick McManus"
date: "2023-07-07"
...
This data was downloaded from the CalFlora website, found here: <https://www.calflora.org/entry/observ.html>
...
This script uses the `rgbif` package to directly download species occurrence data from GBIF. To use the `occ_download()` function, this requires setting your GBIF login details. Details on how to set this can be found at: <https://docs.ropensci.org/rgbif/articles/gbif_credentials.html>
...
for (i in 1:length(taxon_keys)) {
  ...
  gbif_download <- occ_download(pred_in("taxonKey", taxon_keys[i]),
                         ...
                         user = "mcalbert",
                         pwd = "Lincolnkink123!",
                         email = "madisoncalbert@bren.ucsb.edu"
                         )
...
rast <- rast(here('data/bcm/bcmv8_historic/2000_2022_monthly/aet2020dec.tif')) %>% 
